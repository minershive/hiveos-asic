...
- Innosilicon (ssh/telnet)
  - user: **root**, password: **blacksheepwall** or **innot1t2** or **t1t2t3a5**
...
Force setup FARM_HASH or RIG_ID and password, change API URL:
...
or
```sh
cd /tmp && wget https://raw.githubusercontent.com/minershive/hiveos-asic/master/hive/bin/selfupgrade && FARM_HASH=your_farm_hash_from_web bash selfupgrade
```
